...
export const update = async (req, res) => {
    try {
        const { idReclamoEstado, descripcion } = req.body;
        if (!idReclamoEstado) {
        ...
        const reclamoEstadoActualizado = await reclamosEstadoServices.update(parseInt(idReclamoEstado), descripcion);
...
export const destroy = async (req, res) => {
    try {
        ...
        await reclamosEstadoServices.destroy(parseInt(idReclamoEstado));
